...
# Base de datos optimizada a 20 productos con imágenes reales de ropa/uniformes
productos = [
    # === DIARIO MASCULINO (5 Productos) ===
    ...
    {"id": 7, "categoria": "diario-femenino", "nombre": "Jardinera Escolar Plisada (Talla S)", "descripcion": "Jardinera a cuadros institucional, talle alto y costuras de seguridad reforzadas.", "precio": 82000, "imagen": "https://images.unsplash.com/photo-1598198414976-ddb788ec80c1?q=80&w=500&auto=format&fit=crop"},
    ...
    # === ESPECIALIDAD Y ACCESORIOS (5 Productos) ===
    {"id": 16, "categoria": "sistemas", "nombre": "Camiseta Polo Técnica Sistemas (Talla S)", "descripcion": "Camiseta tipo Polo exclusiva azul oscuro con bordados técnicos de la Especialidad de Sistemas. Horma empresarial.", "precio": 44000, "imagen": "https://images.unsplash.com/photo-1618354691373-d851c5c3a990?q=80&w=500&auto=format&fit=crop"},
...
@app.route('/')
def index():
    # El carrusel usará los 3 primeros productos destacados
    carrusel_items = [productos[0], list(filter(lambda p: p['categoria'] == 'diario-femenino', productos))[0], list(filter(lambda p: p['categoria'] == 'sistemas', productos))[0]]
    return render_template('index.html', productos=productos, carrusel=carrusel_items)
